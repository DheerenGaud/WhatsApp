            ...
            <div className="chat">
              ...
              <div className="chat-history">
                <ul className="m-b-0">
                  {messages.map((message, index) => (
                    <li key={index} className={`clearfix ${message.sender === 'You' ? 'my-message' : 'other-message'}`}>
                      <div className="message-data">
                        <span className="message-data-time">{message.time}</span>
                      </div>
                      <div className={`message ${message.sender === 'You' ? 'my-message' : 'other-message'}`}>
                        {message.text}
                      </div>
                    </li>
                  ))}
              ...
              <div className="chat-message clearfix">
                <div className="input-group mb-0">
                  <div className="input-group-prepend">
                    <span className="input-group-text" onClick={() => handleSendMessage('Hello!')}>
